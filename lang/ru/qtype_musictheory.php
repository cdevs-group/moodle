...
/**
 * Strings for component 'qtype_musictheory', language 'ru', version '3.9'.
 *
...
$string['chordquality_write_questionastext_help'] = '<p>Введите список заметок, разделенных запятыми,
...
$string['chordquality_write_questionasui_help'] = '<p>Введите ноты, щелкнув по нотному стану, после выбора
 типа знаков альтерации на правой панели инструментов. Чтобы удалить заметку, нажмите на нее еще раз.</p>';
...
$string['considerregister_help'] = 'Указывает, должен ли регистр заметки быть
...
$string['givennoteelementgroup'] = 'Данная записка';
...
$string['includealterations_help'] = 'Указывает, должен ли регистр заметки быть
 включен как часть вопроса.';
$string['includestaticnote'] = 'Включить данную заметку';
...
$string['interval_write_questionasui_help'] = '<p>Введите ноту, нажав на перечень, после
 выбор типа знака альтерации на правой панели инструментов. Чтобы удалить заметку, нажмите на нее еще раз.</p>';
...
$string['scale_write_questionastext_help'] = '<p>Введите список заметок, разделенных запятыми, включая
 указанный тоник без пробелов, используя следующий синтаксис:</p><p>[Uppercase letter name]
 ...
 <p>Случайный пример: <b>Tonic = An4 answer=>An4,Bb4,C#5,D#5,E#5,F#5,G#5,An5</b></p>';
...
$string['validationerror_notewrite_twonotesingrandstaff'] = 'Были внесены две записи. Пожалуйста, введите только одну заметку.';
