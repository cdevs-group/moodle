...
/**
 * Strings for component 'auth_oidc', language 'ru', version '3.9'.
 *
 * @package     auth_oidc
 * @category    string
...
$string['cfg_field_mapping_desc'] = 'Данные профиля пользователя Moodle можно сопоставить с данными поставщика удостоверений (IdP) OpenID Connect.<br/>
<ул>
<li>Основные данные профиля доступны из токенов ID всех поставщиков удостоверений.</li>
